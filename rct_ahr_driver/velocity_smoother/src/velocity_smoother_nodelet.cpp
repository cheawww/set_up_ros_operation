...
void VelocitySmoother::reconfigCB(velocity_smoother::paramsConfig &config, uint32_t level)
{
...
bool VelocitySmoother::init(ros::NodeHandle& nh)
{
  ...
  dynamic_reconfigure_server = new dynamic_reconfigure::Server<velocity_smoother::paramsConfig>(nh);
