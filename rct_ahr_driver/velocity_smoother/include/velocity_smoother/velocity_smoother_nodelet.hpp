 ...
 *
 * License: BSD
 *   https://raw.github.com/yujinrobot/yujin_ocs/hydro/velocity_smoother/LICENSE
 **/
/*****************************************************************************
 ** Ifdefs
 *****************************************************************************/
...
private:
  ...
  ** Dynamic Reconfigure
  **********************/
  dynamic_reconfigure::Server<velocity_smoother::paramsConfig> *             dynamic_reconfigure_server;
  dynamic_reconfigure::Server<velocity_smoother::paramsConfig>::CallbackType dynamic_reconfigure_callback;
  void reconfigCB(velocity_smoother::paramsConfig &config, uint32_t unused_level);
